...
var toolIndexs = []*Tool{
	{
		...
		Install:   "go get -u strawberrymaker/cmd/snake@" + Version,
		Summary:   "Snake工具集",
	...
	},
	{
		...
		Install:   "go get -u strawberrymaker/cmd/gen-protoc@" + Version,
	...
	},
	{
		...
		Install:      "go get -u strawberrymaker/cmd/snake-gen-project@" + Version,
		BuildTime:    time.Date(2021, 1, 16, 0, 0, 0, 0, time.Local),
		Platform:     []string{"darwin", "linux", "windows"},
		Hidden:       true,
